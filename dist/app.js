...
(function(exports) {
  ...
  exports["component"] = component;
})(PS["App.Component"] = PS["App.Component"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Monad_Aff = PS["Control.Monad.Aff"];
...
(function(exports) {
              ...
              return function (v1) {
                  return Validation(function (a) {
                      return Control_Bind.bind(dictMonad.Bind1())(Data_Newtype.unwrap(newtypeVaildation)(v1)(a))(function (v) {
                          if (v instanceof Valid) {
                              return Control_Bind.bind(dictMonad.Bind1())(Data_Newtype.unwrap(newtypeVaildation)(v2)(v.value1))(function (v3) {
                                  return Control_Applicative.pure(dictMonad.Applicative0())((function () {
                                      ...
                                      throw new Error("Failed pattern match at Polyform.Validation line 104, column 18 - line 106, column 43: " + [ v3.constructor.name ]);
                                  })());
                              });
                          };
                          ...
                          throw new Error("Failed pattern match at Polyform.Validation line 101, column 7 - line 107, column 37: " + [ v.constructor.name ]);
                      });
                  });
              };
          });
  ...
  var hoistFnV = function (dictMonad) {
      return function (dictMonoid) {
          return function (f) {
              return Validation(function ($190) {
                  return Control_Applicative.pure(dictMonad.Applicative0())(f($190));
              });
          };
      };
  };
  var hoistFnMV = function (dictMonad) {
      return function (dictMonoid) {
          return function (f) {
              return f;
          };
...
(function(exports) {
  ...
  var EmailField = (function () {
      function EmailField(value0) {
          this.value0 = value0;
      };
      EmailField.create = function (value0) {
          return new EmailField(value0);
      };
      return EmailField;
  })();
  var PasswordField = (function () {
      function PasswordField(value0) {
          this.value0 = value0;
      };
      PasswordField.create = function (value0) {
          return new PasswordField(value0);
      };
      return PasswordField;
  })();
  var minLength = function (dictMonad) {
      return function (min) {
          return Polyform_Validation.hoistFnV(dictMonad)(Data_Monoid.monoidArray)(function (str) {
              var $28 = Data_String.length(str) > min;
              if ($28) {
              ...
              return new Polyform_Validation.Invalid([ Data_Variant.inj()(new Data_Symbol.IsSymbol(function () {
                  return "minLength";
              }))(Data_Symbol.SProxy.value)(new Data_Tuple.Tuple(min, str)) ]);
          });
      };
  };
  var maxLength = function (dictMonad) {
      return function (max) {
          return Polyform_Validation.hoistFnV(dictMonad)(Data_Monoid.monoidArray)(function (str) {
              var $29 = Data_String.length(str) < max;
              if ($29) {
                  return Control_Applicative.pure(Polyform_Validation.applicativeV(Data_Monoid.monoidArray))(str);
              };
              return new Polyform_Validation.Invalid([ Data_Variant.inj()(new Data_Symbol.IsSymbol(function () {
                  return "maxLength";
              }))(Data_Symbol.SProxy.value)(new Data_Tuple.Tuple(max, str)) ]);
          });
      };
  };
  var hasDigit = function (dictMonad) {
      return Polyform_Validation.hoistFnV(dictMonad)(Data_Monoid.monoidArray)(function (str) {
          var chars = Data_String.toCharArray(str);
          var $30 = Data_Foldable.any(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(function (v) {
              return Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Eq.eqChar)(v)(chars);
          })(Data_String.toCharArray("0123456789"));
          if ($30) {
              return Control_Applicative.pure(Polyform_Validation.applicativeV(Data_Monoid.monoidArray))(str);
          };
          return new Polyform_Validation.Invalid([ Data_Variant.inj()(new Data_Symbol.IsSymbol(function () {
              return "hasDigit";
          }))(Data_Symbol.SProxy.value)(str) ]);
      });
  };
  var passwordFieldValidation = function (dictMonad) {
      return function (min) {
          return function (max) {
              return Control_Semigroupoid.composeFlipped(Polyform_Validation.semigroupoidValidation(dictMonad)(Data_Semigroup.semigroupArray))(maxLength(dictMonad)(max))(Control_Semigroupoid.composeFlipped(Polyform_Validation.semigroupoidValidation(dictMonad)(Data_Semigroup.semigroupArray))(minLength(dictMonad)(min))(hasDigit(dictMonad)));
          };
      };
  };
  var formFromField = function (dictMonad) {
      return function (dictMonoid) {
          return function (accessor) {
              return function (constructor) {
                  return function (record) {
                      return function (fieldValidation) {
                          return Polyform_Validation.Validation(function (inputRecord) {
                              var v = accessor(inputRecord);
                              if (v.validate) {
                                  return Control_Bind.bind(dictMonad.Bind1())(Polyform_Validation.runValidation(fieldValidation)(v.value))(function (v1) {
                                      return Control_Applicative.pure(dictMonad.Applicative0())((function () {
                                          if (v1 instanceof Polyform_Validation.Valid) {
                                              return new Polyform_Validation.Valid(new Data_Tuple.Tuple([  ], [ constructor((function () {
                                                  var $35 = {};
                                                  for (var $36 in record) {
                                                      if ({}.hasOwnProperty.call(record, $36)) {
                                                          $35[$36] = record[$36];
                                                      };
                                                  };
                                                  $35.value = new Polyform_Validation.Valid(v1.value0, v.value);
                                                  return $35;
                                              })()) ]), new Data_Maybe.Just(v1.value1));
                                          };
                                          if (v1 instanceof Polyform_Validation.Invalid) {
                                              return Polyform_Validation.Invalid.create(new Data_Tuple.Tuple([  ], [ constructor((function () {
                                                  var $40 = {};
                                                  for (var $41 in record) {
                                                      if ({}.hasOwnProperty.call(record, $41)) {
                                                          $40[$41] = record[$41];
                                                      };
                                                  };
                                                  $40.value = new Polyform_Validation.Invalid(v1.value0);
                                                  return $40;
                                              })()) ]));
                                          };
                                          throw new Error("Failed pattern match at Form line 195, column 16 - line 201, column 89: " + [ v1.constructor.name ]);
                                      })());
                                  });
                              };
                              return Control_Applicative.pure(dictMonad.Applicative0())(new Polyform_Validation.Valid(new Data_Tuple.Tuple([  ], [ constructor((function () {
                                  var $44 = {};
                                  for (var $45 in record) {
                                      if ({}.hasOwnProperty.call(record, $45)) {
                                          $44[$45] = record[$45];
                                      };
                                  };
                                  $44.value = new Polyform_Validation.Valid(Data_Monoid.mempty(dictMonoid), v.value);
                                  return $44;
  ...
  var emailIsUsed = function (dictMonadEff) {
      return Polyform_Validation.hoistFnMV(dictMonadEff.Monad0())(Data_Monoid.monoidArray)(function (str) {
          return Control_Bind.bind((dictMonadEff.Monad0()).Bind1())(Control_Monad_Eff_Class.liftEff(dictMonadEff)(Control_Monad_Eff_Random.random))(function (v) {
              return Control_Applicative.pure((dictMonadEff.Monad0()).Applicative0())(Control_Applicative.pure(Polyform_Validation.applicativeV(Data_Monoid.monoidArray))(str));
          });
      });
  };
  var emailFormat = function (dictMonad) {
      return Polyform_Validation.hoistFnV(dictMonad)(Data_Monoid.monoidArray)(function (str) {
          var $50 = Data_String.contains("@")(str);
          if ($50) {
              return Control_Applicative.pure(Polyform_Validation.applicativeV(Data_Monoid.monoidArray))(str);
          };
          return new Polyform_Validation.Invalid([ Data_Variant.inj()(new Data_Symbol.IsSymbol(function () {
  ...
  var emailFieldValidation = function (dictMonadEff) {
      return Control_Semigroupoid.composeFlipped(Polyform_Validation.semigroupoidValidation(dictMonadEff.Monad0())(Data_Semigroup.semigroupArray))(emailFormat(dictMonadEff.Monad0()))(emailIsUsed(dictMonadEff));
  };
  var defaultInputString = {
      value: new Polyform_Validation.Valid([  ], "")
  };
  var emailForm = function (dictMonadEff) {
      return formFromField(dictMonadEff.Monad0())(Data_Monoid.monoidArray)(function (v) {
          return v.email;
      })(EmailField.create)(defaultInputString)(emailFieldValidation(dictMonadEff));
  };
  var buildPasswordForm = function (dictMonad) {
      return function (accessor) {
          return formFromField(dictMonad)(Data_Monoid.monoidArray)(accessor)(PasswordField.create)(defaultInputString)(passwordFieldValidation(dictMonad)(5)(50));
      };
  };
  var passwordForm = function (dictMonad) {
      return Control_Semigroupoid.composeFlipped(Polyform_Validation.semigroupoidValidation(dictMonad)(Data_Tuple.semigroupTuple(Data_Semigroup.semigroupArray)(Data_Semigroup.semigroupArray)))(Control_Apply.apply(Polyform_Validation.applyValidation(Data_Tuple.semigroupTuple(Data_Semigroup.semigroupArray)(Data_Semigroup.semigroupArray))(dictMonad))(Data_Functor.map(Polyform_Validation.functorValidation(((dictMonad.Bind1()).Apply0()).Functor0()))(Control_Apply.lift2(Data_Maybe.applyMaybe)(function (v) {
          return function (v1) {
              return {
                  password1: v,
                  password2: v1
      ...
      }))(buildPasswordForm(dictMonad)(function (v) {
          return v.password1;
      })))(buildPasswordForm(dictMonad)(function (v) {
          return v.password2;
      })))(Polyform_Validation.hoistFnV(dictMonad)(Data_Tuple.monoidTuple(Data_Monoid.monoidArray)(Data_Monoid.monoidArray))(function (v) {
          if (v instanceof Data_Maybe.Nothing) {
              return Control_Applicative.pure(Polyform_Validation.applicativeV(Data_Tuple.monoidTuple(Data_Monoid.monoidArray)(Data_Monoid.monoidArray)))(Data_Maybe.Nothing.value);
          };
          if (v instanceof Data_Maybe.Just) {
              var $52 = v.value0.password1 === v.value0.password2;
              if ($52) {
                  return Control_Applicative.pure(Polyform_Validation.applicativeV(Data_Tuple.monoidTuple(Data_Monoid.monoidArray)(Data_Monoid.monoidArray)))(new Data_Maybe.Just(v.value0.password1));
              };
              return Polyform_Validation.Invalid.create(new Data_Tuple.Tuple([ "Password dont match" ], [  ]));
          };
          throw new Error("Failed pattern match at Form line 232, column 28 - line 237, column 58: " + [ v.constructor.name ]);
      }));
  };
  var signupForm = function (dictMonadEff) {
      return Control_Apply.apply(Polyform_Validation.applyValidation(Data_Tuple.semigroupTuple(Data_Semigroup.semigroupArray)(Data_Semigroup.semigroupArray))(dictMonadEff.Monad0()))(Data_Functor.map(Polyform_Validation.functorValidation((((dictMonadEff.Monad0()).Bind1()).Apply0()).Functor0()))(Control_Apply.lift2(Data_Maybe.applyMaybe)(function (v) {
          return function (v1) {
              return {
                  password: v,
                  email: v1
      ...
      }))(passwordForm(dictMonadEff.Monad0())))(emailForm(dictMonadEff));
  };
  ...
  exports["passwordFieldValidation"] = passwordFieldValidation;
  exports["EmailField"] = EmailField;
  exports["PasswordField"] = PasswordField;
  exports["defaultInputString"] = defaultInputString;
  exports["formFromField"] = formFromField;
  exports["emailForm"] = emailForm;
  exports["buildPasswordForm"] = buildPasswordForm;
...
(function(exports) {
  ...
  var printResult = function (v) {
      if (v instanceof Polyform_Validation.Valid) {
          return function __do() {
              Control_Monad_Eff_Console.log("FORM VALID:")();
              Debug_Trace.traceAnyA(Debug_Trace.warn())(Control_Monad_Eff.applicativeEff)(v.value0)();
              Control_Monad_Eff_Console.log("FINAL VALUE:")();
              return Debug_Trace.traceAnyA(Debug_Trace.warn())(Control_Monad_Eff.applicativeEff)(v.value1)();
          };
      };
      if (v instanceof Polyform_Validation.Invalid) {
          return function __do() {
              Control_Monad_Eff_Console.log("FORM INVALID:")();
              return Debug_Trace.traceAnyA(Debug_Trace.warn())(Control_Monad_Eff.applicativeEff)(v.value0)();
          };
      };
      throw new Error("Failed pattern match at Form.Run line 16, column 3 - line 25, column 21: " + [ v.constructor.name ]);
  };
  var notValidate = function (value) {
      return {
          value: value,
          validate: false
      };
  ...
  exports["notValidate"] = notValidate;
})(PS["Form.Run"] = PS["Form.Run"] || {});
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
(function(exports) {
  // Generated by purs version 0.11.7
  "use strict";
  var App_Component = PS["App.Component"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad_Aff = PS["Control.Monad.Aff"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var Control_Monad_Eff_Class = PS["Control.Monad.Eff.Class"];
  ...
  var main = function __do() {
      Control_Monad_Eff_Console.log("EXAMPLE")();
      var v = Polyform_Validation.runValidation(Form.signupForm(Control_Monad_Eff_Class.monadEffEff))({
          email: Form_Run.notValidate("wrongemailformat"),
          password1: Form_Run.notValidate("shrt"),
          password2: Form_Run.notValidate("nodigits")
      })();
      Form_Run.printResult(v)();
      var v2 = Polyform_Validation.runValidation(Form.signupForm(Control_Monad_Eff_Class.monadEffEff))({
          email: Form_Run.validate("wrongemailformat"),
          password1: Form_Run.notValidate("shrt"),
          password2: Form_Run.notValidate("nodigits")
      })();
      Form_Run.printResult(v2)();
      var v3 = Polyform_Validation.runValidation(Form.signupForm(Control_Monad_Eff_Class.monadEffEff))({
          email: Form_Run.validate("email@example.com"),
          password1: Form_Run.notValidate("shrt"),
          password2: Form_Run.notValidate("nodigits")
      })();
      Form_Run.printResult(v3)();
      var v4 = Polyform_Validation.runValidation(Form.signupForm(Control_Monad_Eff_Class.monadEffEff))({
          email: Form_Run.validate("wrongemailformat"),
          password1: Form_Run.validate("shrt"),
          password2: Form_Run.notValidate("nodigits")
      })();
      Form_Run.printResult(v4)();
      var v5 = Polyform_Validation.runValidation(Form.signupForm(Control_Monad_Eff_Class.monadEffEff))({
          email: Form_Run.validate("wrongemailformat"),
          password1: Form_Run.validate("shrt"),
          password2: Form_Run.validate("nodigits")
      })();
      Form_Run.printResult(v5)();
      var v6 = Polyform_Validation.runValidation(Form.signupForm(Control_Monad_Eff_Class.monadEffEff))({
          email: Form_Run.validate("email@example.com"),
          password1: Form_Run.validate("password921"),
          password2: Form_Run.validate("password921")
      })();
      Form_Run.printResult(v6)();
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v7) {
          return Halogen_VDom_Driver.runUI(App_Component.component)(Data_Unit.unit)(v7);
      }))();
  };
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
